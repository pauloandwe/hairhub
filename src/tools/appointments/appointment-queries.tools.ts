...
- Expressoes naturais de data, como "dia 16", "16 de marco", "amanha", "sexta" e "proxima segunda", sao resolvidas internamente. Nesses casos, pode chamar a tool mesmo sem data ISO completa.
...
- "Consegue ver segunda pra mim se tem?" → getAvailableTimeSlots({})
