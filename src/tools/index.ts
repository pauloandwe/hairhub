...
import { appointmentCancellationTools } from './appointments/appointment-cancellation.tools'
...
export const allTools: OpenAITool[] = [...appointmentTools, ...appointmentCancellationTools, ...appointmentRescheduleTools, ...appointmentQueryTools, ...unsupportedRegistrationTools, ...unsupportedQueryTools]
